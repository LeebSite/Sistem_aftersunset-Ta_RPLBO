        ...
        <div class="row">
            <div class="col-md-12">
                <div class="error-template min-vh-100 d-flex flex-column justify-content-center">
                    <i class="fas fa-question-circle text-primary mb-4" style="font-size: 6rem;"></i>
                    <h1 class="display-4 mb-2 font-extrabold">404</h1>
                    <h2 class="mb-3 font ">Halaman Tidak Ditemukan</h2>
                    <div class="error-details mb-4 ">
                        Maaf, kami tidak dapat menemukan halaman yang Anda cari.
                    </div>
                    <div class="error-actions">
                        <a href="/beranda" class="btn btn-primary btn-lg">
